...
namespace PA1
{
    class Program
    {
                        ...
                        else
                        {
                            do
                            {
                                ...
                                switch (ch2)
                                {
                                    ...
                                    case '1': 
                                        AddGradStudent(gslist);
                                        break;
                                    //TODO (2): Add new undergrad Student,
                                    case '2': 
                                        AddUnderGradStudent(ugslist);
                                        break;
                                    case '3':
        ...
        public static GradStudent AddGradStudent(List<User> gList){
            string sName;
            float gpa;
            string DoB; 
            ...
            PrevUniversity = Console.ReadLine();

            Console.Write("Enter UnderGrad GPA: ");
            ugGpa = float.Parse(Console.ReadLine());

            GradStudent output = new GradStudent(sName, gpa, DoB, PrevUniversity, ugGpa);
        ...
        public static Course AddCourse(List<Course> coursesList){
            string cn; 
            int id; 
            int credits;
            ...
            Console.Write("Number of credit hours: ");
            credits = int.Parse(Console.ReadLine());

            Course output = new Course(cn, id, credits);
            if(findCourse(coursesList, id) == null){
                coursesList.Add(output);
                return output;
            }
            return null;
        }
